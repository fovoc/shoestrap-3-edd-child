...
if ( is_user_logged_in() ):
	...
	<form id="edd_profile_editor_form" class="edd_form form-horizontal" action="<?php echo edd_get_current_page_url(); ?>" method="post">
		<fieldset>
			...
			<legend><?php _e( 'Change your Billing Address', 'edd' ); ?></legend>

			<div class="form-group" id="edd_profile_billing_address_wrap">
				<label for="edd_address_line1" class="col-md-3 control-label"><?php _e( 'Line 1', 'edd' ); ?></label>
				<div class="col-md-9">
					<input name="edd_address_line1" id="edd_address_line1" class="form-control text edd-input" type="text" value="<?php echo $address['line1']; ?>" />
				</div>
			</div>
			<div class="form-group">
				<label for="edd_address_line2" class="col-md-3 control-label"><?php _e( 'Line 2', 'edd' ); ?></label>
				<div class="col-md-9">
					<input name="edd_address_line2" id="edd_address_line2" class="form-control text edd-input" type="text" value="<?php echo $address['line2']; ?>" />
				</div>
			</div>
			<div class="form-group">
				<label for="edd_address_city" class="col-md-3 control-label"><?php _e( 'City', 'edd' ); ?></label>
				<div class="col-md-9">
					<input name="edd_address_city" id="edd_address_city" class="form-control text edd-input" type="text" value="<?php echo $address['city']; ?>" />
				</div>
			</div>
			<div class="form-group">
				<label for="edd_address_zip" class="col-md-3 control-label"><?php _e( 'Zip / Postal Code', 'edd' ); ?></label>
				<div class="col-md-9">
					<input name="edd_address_zip" id="edd_address_zip" class="form-control text edd-input" type="text" value="<?php echo $address['zip']; ?>" />
				</div>
			</div>
			<div class="form-group">
				<label for="edd_address_country" class="col-md-3 control-label"><?php _e( 'Country', 'edd' ); ?></label>
				<div class="col-md-9">
			...
			<div class="form-group">
				<label for="edd_address_state" class="col-md-3 control-label"><?php _e( 'State / Province', 'edd' ); ?></label>
				<div class="col-md-9">
					<input name="edd_address_state" id="edd_address_state" class="form-control text edd-input" type="text" value="<?php echo $address['state']; ?>" />
				</div>
			</div>

	...
	<form id="edd_profile_editor_form" class="edd_form" action="<?php echo edd_get_current_page_url(); ?>" method="post">
		<fieldset>
			...
			<p id="edd_profile_name_wrap">
				...
				<input name="edd_first_name" id="edd_first_name" class="<?php echo $input_class; ?>text edd-input" type="text" value="<?php echo $first_name; ?>" />
				<br />
				<label for="edd_last_name"><?php _e( 'Last Name', 'edd' ); ?></label>
				<input name="edd_last_name" id="edd_last_name" class="<?php echo $input_class; ?>text edd-input" type="text" value="<?php echo $last_name; ?>" />
			</p>
			<p id="edd_profile_display_name_wrap">
				<label for="edd_display_name"><?php _e( 'Display Name', 'edd' ); ?></label>
				<select name="edd_display_name" id="edd_display_name" class="<?php echo $input_class; ?>select edd-select">
			...
			<p>
				...
				<input name="edd_email" id="edd_email" class="<?php echo $input_class; ?>text edd-input required" type="email" value="<?php echo $current_user->user_email; ?>" />
			</p>
			...
			<p id="edd_profile_billing_address_wrap">
				...
				<input name="edd_address_line1" id="edd_address_line1" class="<?php echo $input_class; ?>text edd-input" type="text" value="<?php echo $address['line1']; ?>" />
				<br/>
				<label for="edd_address_line2"><?php _e( 'Line 2', 'edd' ); ?></label>
				<input name="edd_address_line2" id="edd_address_line2" class="<?php echo $input_class; ?>text edd-input" type="text" value="<?php echo $address['line2']; ?>" />
				<br/>
				<label for="edd_address_city"><?php _e( 'City', 'edd' ); ?></label>
				<input name="edd_address_city" id="edd_address_city" class="<?php echo $input_class; ?>text edd-input" type="text" value="<?php echo $address['city']; ?>" />
				<br/>
				<label for="edd_address_zip"><?php _e( 'Zip / Postal Code', 'edd' ); ?></label>
				<input name="edd_address_zip" id="edd_address_zip" class="<?php echo $input_class; ?>text edd-input" type="text" value="<?php echo $address['zip']; ?>" />
				<br/>
				<label for="edd_address_country"><?php _e( 'Country', 'edd' ); ?></label>
				<select name="edd_address_country" id="edd_address_country" class="<?php echo $input_class; ?>select edd-select">
				...
				<input name="edd_address_state" id="edd_address_state" class="<?php echo $input_class; ?>text edd-input" type="text" value="<?php echo $address['state']; ?>" />
				<br/>
			</p>
			...
			<p id="edd_profile_password_wrap">
				...
				<input name="edd_new_user_pass1" id="edd_new_user_pass1" class="<?php echo $input_class; ?>password edd-input" type="password"/>
				<br />
				<label for="edd_user_pass"><?php _e( 'Re-enter Password', 'edd' ); ?></label>
				<input name="edd_new_user_pass2" id="edd_new_user_pass2" class="<?php echo $input_class; ?>password edd-input" type="password"/>
			</p>
			...
			<p id="edd_profile_submit_wrap">
				...
				<input name="edd_profile_editor_submit" id="edd_profile_editor_submit" type="submit" class="<?php echo $ss_framework->button_classes( 'default', 'medium', null, 'edd_submit' ); ?>" value="<?php _e( 'Save Changes', 'edd' ); ?>"/>
			</p>
		</fieldset>
	</form><!-- #edd_profile_editor_form -->
	<?php
else:
	echo $ss_framework->alert( 'warning', __( 'You need to login to edit your profile.', 'edd' ) . edd_login_form(), null );
endif;
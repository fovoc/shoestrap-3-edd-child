...
echo '<div class="pull-left left sort">';
	...
	echo $ss_framework->make_dropdown_button( 'default', 'medium', null, 'btn-name', __( 'Name', 'shoestrap_edd' ), $content );

	echo $ss_framework->make_dropdown_button( 'default', 'medium', null, 'btn-price', __( 'Price', 'shoestrap_edd' ), $content );
